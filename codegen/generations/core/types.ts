...
export const Get_Users_QueryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GET_USERS_QUERY' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<Get_Users_QueryQuery, Get_Users_QueryQueryVariables>
...
export type Get_Users_QueryQuery = {
  __typename?: 'Query'
